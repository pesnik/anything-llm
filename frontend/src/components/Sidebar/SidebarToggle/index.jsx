...
export function ToggleSidebarButton({ showSidebar, setShowSidebar }) {
  ...
  return (
    <>
      <button
        type="button"
        className={`hidden md:block border-none bg-transparent outline-none ring-0 absolute transition-all duration-500 z-10 ${showSidebar ? "top-[26px] left-[248px]" : "top-[20px] left-[30px]"}`}
